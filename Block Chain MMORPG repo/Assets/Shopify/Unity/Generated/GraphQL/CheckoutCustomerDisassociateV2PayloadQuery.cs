namespace Shopify.Unity.GraphQL {
    ...
    public delegate void CheckoutCustomerDisassociateV2payloadDelegate(CheckoutCustomerDisassociateV2payloadQuery query);

    /// <summary>
    /// Return type for `checkoutCustomerDisassociateV2` mutation.
    /// </summary>
    public class CheckoutCustomerDisassociateV2payloadQuery {
        private StringBuilder Query;

        /// <summary>
        /// <see cref="CheckoutCustomerDisassociateV2payloadQuery" /> is used to build queries. Typically
        /// <see cref="CheckoutCustomerDisassociateV2payloadQuery" /> will not be used directly but instead will be used when building queries from either
        /// <see cref="QueryRootQuery" /> or <see cref="MutationQuery" />.
        /// </summary>
        public CheckoutCustomerDisassociateV2payloadQuery(StringBuilder query) {
            Query = query;
        }
