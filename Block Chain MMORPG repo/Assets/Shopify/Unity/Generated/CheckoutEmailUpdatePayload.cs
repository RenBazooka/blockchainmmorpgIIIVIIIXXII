namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutEmailUpdatePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutEmailUpdatePayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutEmailUpdatePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutEmailUpdatePayload</param>
        public CheckoutEmailUpdatePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutEmailUpdatePayload(DataJSON);
        }
