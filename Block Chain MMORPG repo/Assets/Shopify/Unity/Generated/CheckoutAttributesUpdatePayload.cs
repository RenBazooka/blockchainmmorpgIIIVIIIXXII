namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutAttributesUpdatePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutAttributesUpdatePayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutAttributesUpdatePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutAttributesUpdatePayload</param>
        public CheckoutAttributesUpdatePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutAttributesUpdatePayload(DataJSON);
        }
