namespace Shopify.Unity {
    ...
    /// </summary>
    public class CustomerResetPayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CustomerResetPayload" /> Accepts deserialized json data.
        /// <see ref="CustomerResetPayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CustomerResetPayload</param>
        public CustomerResetPayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CustomerResetPayload(DataJSON);
        }
