namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutCustomerAssociateV2payload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutCustomerAssociateV2payload" /> Accepts deserialized json data.
        /// <see ref="CheckoutCustomerAssociateV2payload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutCustomerAssociateV2payload</param>
        public CheckoutCustomerAssociateV2payload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutCustomerAssociateV2payload(DataJSON);
        }
