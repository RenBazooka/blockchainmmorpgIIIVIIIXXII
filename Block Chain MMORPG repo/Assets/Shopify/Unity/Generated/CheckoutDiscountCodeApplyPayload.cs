namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutDiscountCodeApplyPayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutDiscountCodeApplyPayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutDiscountCodeApplyPayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutDiscountCodeApplyPayload</param>
        public CheckoutDiscountCodeApplyPayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutDiscountCodeApplyPayload(DataJSON);
        }
