namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutGiftCardApplyPayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutGiftCardApplyPayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutGiftCardApplyPayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutGiftCardApplyPayload</param>
        public CheckoutGiftCardApplyPayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutGiftCardApplyPayload(DataJSON);
        }
