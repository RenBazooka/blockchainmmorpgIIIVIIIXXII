namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutGiftCardRemovePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutGiftCardRemovePayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutGiftCardRemovePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutGiftCardRemovePayload</param>
        public CheckoutGiftCardRemovePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutGiftCardRemovePayload(DataJSON);
        }
