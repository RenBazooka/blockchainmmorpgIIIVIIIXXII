namespace Shopify.Unity {
    ...
    /// </summary>
    public class AutomaticDiscountApplication : AbstractResponse, ICloneable, DiscountApplication {
        /// <summary>
        /// <see ref="AutomaticDiscountApplication" /> Accepts deserialized json data.
        /// <see ref="AutomaticDiscountApplication" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for AutomaticDiscountApplication</param>
        public AutomaticDiscountApplication(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
