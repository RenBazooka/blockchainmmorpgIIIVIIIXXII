namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutCompleteWithCreditCardPayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutCompleteWithCreditCardPayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutCompleteWithCreditCardPayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutCompleteWithCreditCardPayload</param>
        public CheckoutCompleteWithCreditCardPayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutCompleteWithCreditCardPayload(DataJSON);
        }
