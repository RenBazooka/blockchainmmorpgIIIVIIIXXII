namespace Shopify.Unity {
    ...
    /// </summary>
    public class CustomerResetByUrlPayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CustomerResetByUrlPayload" /> Accepts deserialized json data.
        /// <see ref="CustomerResetByUrlPayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CustomerResetByUrlPayload</param>
        public CustomerResetByUrlPayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CustomerResetByUrlPayload(DataJSON);
        }
