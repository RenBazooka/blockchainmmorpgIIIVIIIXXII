namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutCompleteWithTokenizedPaymentV2payload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutCompleteWithTokenizedPaymentV2payload" /> Accepts deserialized json data.
        /// <see ref="CheckoutCompleteWithTokenizedPaymentV2payload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutCompleteWithTokenizedPaymentV2payload</param>
        public CheckoutCompleteWithTokenizedPaymentV2payload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutCompleteWithTokenizedPaymentV2payload(DataJSON);
        }
