namespace Shopify.Unity {
    ...
    /// </summary>
    public class CustomerUpdatePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CustomerUpdatePayload" /> Accepts deserialized json data.
        /// <see ref="CustomerUpdatePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CustomerUpdatePayload</param>
        public CustomerUpdatePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CustomerUpdatePayload(DataJSON);
        }
