namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutCreatePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CheckoutCreatePayload" /> Accepts deserialized json data.
        /// <see ref="CheckoutCreatePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CheckoutCreatePayload</param>
        public CheckoutCreatePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CheckoutCreatePayload(DataJSON);
        }
