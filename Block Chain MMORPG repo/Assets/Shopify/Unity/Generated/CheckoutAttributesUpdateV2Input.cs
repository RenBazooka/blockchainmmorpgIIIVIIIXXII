namespace Shopify.Unity {
    ...
    /// </summary>
    public class CheckoutAttributesUpdateV2input : InputBase {
        ...
        /// Full validation of the addresses is still done at complete time.
        /// </param>
        public CheckoutAttributesUpdateV2input(string note = null,List<AttributeInput> customAttributes = null,bool? allowPartialAddresses = null) {
            if (note != null) {
        ...
        /// Full validation of the addresses is still done at complete time.
        /// </param>
        public CheckoutAttributesUpdateV2input(Dictionary<string, object> dataJSON) {
