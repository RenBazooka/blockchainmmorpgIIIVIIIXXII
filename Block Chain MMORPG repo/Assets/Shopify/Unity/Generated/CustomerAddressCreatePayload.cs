namespace Shopify.Unity {
    ...
    /// </summary>
    public class CustomerAddressCreatePayload : AbstractResponse, ICloneable {
        /// <summary>
        /// <see ref="CustomerAddressCreatePayload" /> Accepts deserialized json data.
        /// <see ref="CustomerAddressCreatePayload" /> Will further parse passed in data.
        /// </summary>
        /// <param name="dataJSON">Deserialized JSON data for CustomerAddressCreatePayload</param>
        public CustomerAddressCreatePayload(Dictionary<string, object> dataJSON) {
            DataJSON = dataJSON;
        ...
        public object Clone() {
            return new CustomerAddressCreatePayload(DataJSON);
        }
