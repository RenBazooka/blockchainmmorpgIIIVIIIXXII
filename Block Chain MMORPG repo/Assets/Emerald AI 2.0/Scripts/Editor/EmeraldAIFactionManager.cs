...
public class EmeraldAIFactionManager : EditorWindow {
	...
	void OnGUI(){
		...
		EditorGUILayout.LabelField("Emerald AI Faction Manager - v1.0", style, GUILayout.ExpandWidth(true));
	...
	void LoadFactionData()
	{
		...
		if (FactionData != null){
			...
			FactionList = new List<string>(Emerald_AI.StringFactionList);
		}
	}
	...
	void SaveFactionData()
	{
		...
		Emerald_AI.StringFactionList = new List<string>(FactionList);
		writer.Close();
